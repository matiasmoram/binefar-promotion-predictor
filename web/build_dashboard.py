...
TEMPLATE = r"""
<style>
/* CD Binéfar "floodlit" identity: blue-and-white club colours (cool blue paper
   in light, night-match navy in dark), one bold club-red accent, a condensed
   scoreboard display face + monospace data. Deliberately NOT the cream/serif/
   terracotta look. */
:root{
  --bg:#e7ecf4; --card:#ffffff; --card2:#eef2f9; --fg:#0b1f44; --muted:#5b6a88;
  --line:#d1dae8; --blue:#123f8c; --accent:#d1232b; --accent-soft:#f6dbdb; --accent2:#2f5eaa;
  --good:#1f7a4d; --warn:#b0742a; --pitch1:#2f6d4a; --pitch2:#285f40;
  --shadow:0 1px 2px rgba(11,31,68,.06),0 10px 26px rgba(11,31,68,.09);
  --radius:10px; --maxw:1120px;
  --display:"Arial Narrow","Roboto Condensed","Oswald","Bebas Neue","Helvetica Neue Condensed",Impact,system-ui,sans-serif;
  --sans:ui-sans-serif,system-ui,-apple-system,"Segoe UI",Roboto,Helvetica,Arial,sans-serif;
  --mono:ui-monospace,"SF Mono","SFMono-Regular",Menlo,Consolas,"Liberation Mono",monospace;
}
@media (prefers-color-scheme:dark){:root{
  --bg:#0a1830; --card:#0f2143; --card2:#0c1c3a; --fg:#eaf1fc; --muted:#8ea3c8;
  --line:#213458; --blue:#5b8bff; --accent:#ff5a5f; --accent-soft:#3a1b1e; --accent2:#6f9bff;
  --good:#46b98a; --warn:#e0a05a; --pitch1:#20553a; --pitch2:#194630;
...
.crest{width:44px;height:52px;display:grid;place-items:center;
  clip-path:polygon(0 0,100% 0,100% 68%,50% 100%,0 68%);
  background:linear-gradient(160deg,var(--blue),color-mix(in srgb,var(--blue) 60%,#000));
  color:#fff;font-weight:700;font-size:18px;letter-spacing:0;box-shadow:var(--shadow);font-family:var(--display)}
.brand h1{font-size:clamp(23px,3vw,30px); font-weight:700; text-transform:uppercase; letter-spacing:.02em}
...
<div class="wrap">
  ...
  <section class="section">
    <div class="section-h"><h2>Squad &amp; lineup</h2><span class="note">click a player · disc size = predicted goals · red ring = penalty taker</span></div>
